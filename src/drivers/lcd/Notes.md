...
- RESX (RST?): reset pin, low when powering up, high at other times
- CS: chipselect, low = enabled
- DC: controls mode: 0 = command 1 = data
...
pg. 35
4-line protocol shows CS happen just before SDA and SCL turn on
