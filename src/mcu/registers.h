...
#define SDIO_ICR_DBCKENDC (BIT(10))
#define SDIO_ICR_DATAENDC (BIT(8))
#define SDIO_ICR_CMDSENTC (BIT(7))
#define SDIO_ICR_CMDRENDC (BIT(6))
#define SDIO_ICR_RXOVERRC (BIT(5))
#define SDIO_ICR_TXUNDERRC (BIT(4))
#define SDIO_ICR_DTIMEOUTC (BIT(3))
#define SDIO_ICR_CTIMEOUTC (BIT(2))
#define SDIO_ICR_DCRCFAILC (BIT(1))
#define SDIO_ICR_CCRCFAILC (BIT(0))
